...
if __name__ == '__main__':
    ...
    parser.add_argument("--cam_out_dir", default="result/cam/", type=str, help="You can use CAM generated by any method, but please ensure that
    the format is consistent with the CAM generated by this code.")
